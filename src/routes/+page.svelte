...
<div class="min-h-screen flex flex-col bg-[#c03556]">
		...
		<div class="max-w-2xl w-full text-center space-y-8">
			...
			<div class="flex justify-center">
				<img
					src="/logo.png"
					alt="Griffin Dow"
					class="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover ring-4 ring-[#a16a8a] shadow-2xl shadow-[#a16a8a]/30"
				/>
			</div>

			<!-- Name -->
			<h1 class="text-5xl md:text-6xl font-bold tracking-tight text-[#F5E6D3]">Griffin Dow</h1>

			<!-- Title -->
			<p class="text-xl md:text-2xl font-medium text-[#F5E6D3]">Product Engineer</p>

			<!-- Tagline -->
			<p class="text-lg text-[#F5E6D3]/95 max-w-xl mx-auto leading-relaxed drop-shadow">
				Relentlessly shaped by vision, I build toward what does not yet exist — beginning with
				myself.
			</p>
	...
	<footer class="py-6 text-center text-[#F5E6D3]/80 text-sm">
		<p>© {new Date().getFullYear()} Griffin Dow</p>
	</footer>
</div>
